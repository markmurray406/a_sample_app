class Occupation < ActiveRecord::Base
  ...
  #Adding association to talent model, see notes and RailsCasts Add Polymorphic Associations.
  has_many :talents, as: :talented
  ...
  # Adding association between occupation and skills
  has_many :skills
